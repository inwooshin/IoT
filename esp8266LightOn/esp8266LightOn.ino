...
void handlethis (){ //onoff 에 접속할때 실행할 내용
  digitalWrite(bulb, HIGH);
  delay(500);
  digitalWrite(bulb, LOW);
  delay(500);
  ...
  digitalWrite(bulb, LOW);
  delay(500);
  server.send(200, "text/plain", "light on off mix that U knw");
}
